  ...
  const SecurityAlertsData = [
    {
      ...
      description: "[MàJ] Multiples vulnérabilités dans Ivanti Connect Secure et Policy Secure Gateways",
                ...
                <Box
                  sx={{
                    ...
                    "&::before": {
                      ...
                      borderRadius: "20px",
                      padding: "2px",
                      background: "linear-gradient(46.93deg, #BE0011 -9.61%, #BE0011 78.14%)",
                    ...
                    >
                      <Box>
                        ...
                        <label htmlFor="pdf-share-button">
                          ...
                          >
                            <circle cx="21" cy="21" r="20.5962" stroke="#222D55" stroke-width="0.807692" />
                            <path
